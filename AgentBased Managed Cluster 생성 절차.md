...
```
$ oc label mcl ${ManagedCluster} policies.event-topic=ocpevent policies.journal-topic=ocpsystem policies.infra-topic=infra policies.syslog-url=192.168.10.100..514
