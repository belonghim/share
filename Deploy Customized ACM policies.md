...
```
$ oc label mcl local-cluster policies.event-topic=ocpevent policies.journal-topic=ocpsystem policies.infra-topic=ocplog policies.syslog-url="192.168.10.100..514"
```
